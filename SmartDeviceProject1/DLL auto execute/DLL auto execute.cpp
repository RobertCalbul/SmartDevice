// DLL auto execute.cpp: define el punto de entrada de la aplicación.
//
...
HWND				g_hWndMenuBar;		// identificador de barra de menús
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message) 
    {
        ...
        case WM_CREATE:
            ...
            // Inicializar la estructura de información para activar el shell
        ...
        case WM_ACTIVATE:
            // Notificar al shell el mensaje de activación
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)
    {
        case WM_INITDIALOG:
            {
                // Cree un botón Listo y ajuste su tamaño.  
                SHINITDLGINFO shidi;
